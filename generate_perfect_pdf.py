# generate_perfect_pdf.py
from reportlab.lib.pagesizes import letter
from reportlab.pdfgen import canvas
import os

def create_mock_indenture(filename="perfect_indenture.pdf"):
    ...
    c.drawString(72, 700, "INDENTURE: Octagon Investment Partners Mock CLO (Perfect Version)")
    
    c.setFont("Helvetica", 12)
    text_page_1 = [
        "1. Capital Structure:",
        "The target principal amount of the collateral obligations is $400,000,000.",
        "Class A-1 Notes: $100,000,000. Target Rating: AAA. Interest Rate: SOFR + 1.35%.",
        "Class B Notes: $50,000,000. Target Rating: AA. Interest Rate: SOFR + 2.00%.",
        "Class C Notes: $50,000,000. Target Rating: BBB. Interest Rate: SOFR + 3.10%.",
        "Subordinated Notes (Equity): $200,000,000. Target Rating: NR. Interest Rate: Residual.",
        "",
    ...
    text_page_2 = [
        "3. Coverage Tests:",
        "Class A/B Overcollateralization (OC) Trigger: 150.0%.",
        "Class C Overcollateralization (OC) Trigger: 130.0%.",
        "Class A/B Interest Coverage (IC) Trigger: 150.0%.",
